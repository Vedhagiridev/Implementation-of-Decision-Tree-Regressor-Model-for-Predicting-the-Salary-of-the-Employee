...
2. Select important features such as experience, education, age, and job role as input data, and salary as the target variable.

3. Split the dataset into training data and testing data.

4. Create and train the Decision Tree Regressor model using the training dataset.
5. Predict employee salaries for test data and evaluate the model performance.
...
<img width="1375" height="240" alt="Screenshot 2026-05-14 104635" src="https://github.com/user-attachments/assets/0ca7833b-4e93-46ad-a2b1-993faa1eba4d" />
<img width="1040" height="618" alt="image" src="https://github.com/user-attachments/assets/a01ce2dd-aad4-47ce-9e0f-b3d64c2ebd86" />
